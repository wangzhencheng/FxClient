...
public class CMDTools {
    ...
    public static void main(String[] args) throws Exception {
        String jarPath = "E:\\work\\idea_workspace\\websoket\\src\\main\\resources\\static\\ws.jar";
        String cmd = "java -Dfile.encoding=UTF-8 -jar " + jarPath;
        CMDTools cmdTools = new CMDTools();
        cmdTools.setOnGetLine(new OnGetLine() {
            @Override
            public void onGetLine(CMDTools cmdTools, String tag, String line) {
                if (line != null && line.contains("Tomcat started on port(s)")) {
                    System.out.println("!!!!!!!!可以加载网页了!");
                }else{
